...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_PrimitiveType = 92,             /* PrimitiveType  */
...
static const yytype_uint8 yyrline[] =
{
     ...
     120,   123,   123,   125,   125,   125,   128,   130,   130,   133,
     133,   136,   138,   138,   141,   141,   141,   144
};
#endif
...
static const char *const yytname[] =
{
  ...
  "FOR", "TO", "ENDFOR", "PASS", "VARNAME", "NUMBER", "CHAR_CONST",
  "STRING_CONST", "COMMENT", "$accept", "Program", "$@1", "$@2", "Func",
  "$@3", "Proc", "$@4", "CommentCheck", "$@5", "NewLineCheck",
  "ProcHeader", "$@6", "$@7", "$@8", "FuncHeader", "$@9", "$@10", "$@11",
  "$@12", "$@13", "Sections", "$@14", "$@15", "Section", "$@16", "$@17",
  "$@18", "Parameters", "$@19", "Var", "$@20", "Type", "$@21",
  "PrimitiveType", "Body", YY_NULLPTR
};
...
{
     -15,   -46,   -41,     8,   -60,   -60,   -14,   -14,   -60,   -60,
     -60,   -60,   -18,   -60,   -60,   -14,   -14,   -30,   -30,   -30,
     -30,   -30,   -30,   -60,    -8,    -9,   -22,   -22,    11,    12,
     -14,   -60,   -60,   -60,   -60,   -60,   -60,   -60,   -30,   -20,
     -20,   -60,   -60,     7,   -60,     5,     1,     7,   -14,   -60,
      16,   -60,   -60,    19,   -30,   -14,   -60,   -20,   -20,   -11,
     -60,   -60,   -30,     6,     9,   -60,   -60,   -60,   -60,   -60,
     -60,   -60,   -60,   -60,   -60,   -11,   -20,   -11,   -11,    20,
     -60,   -60,   -60,   -60
};
...
static const yytype_int8 yydefact[] =
{
      ...
      16,     3,     5,    47,    11,     9,    22,    18,    12,     0,
       0,    14,    39,    23,    30,     0,    36,    19,    16,    27,
       0,    33,    31,     0,    12,    16,    24,     0,     0,     0,
      20,    40,    12,     0,     0,    38,    42,    44,    45,    46,
      32,    41,    28,    25,    34,     0,     0,     0,     0,     0,
      29,    26,    35,    43
};
...
{
     -60,   -60,   -60,   -60,    21,   -60,    22,   -60,   -16,   -60,
      -6,   -60,   -60,   -60,   -60,   -60,   -60,   -60,   -60,   -60,
     -60,    10,   -60,   -60,   -28,   -60,   -60,   -60,   -60,   -60,
     -32,   -60,   -59,   -60,   -60,    24
};
...
static const yytype_int8 yydefgoto[] =
{
      ...
      12,     6,    16,    40,    53,     7,    15,    39,    50,    63,
      77,    43,    55,    76,    44,    59,    57,    78,    45,    58,
      46,    48,    70,    75,    71,    34
};
...
{
      13,    14,    25,    26,    27,    28,    29,     8,    10,    21,
      22,    66,     9,    67,    68,    69,    79,    11,    81,    82,
      -4,     1,    41,     2,    38,    64,    65,    23,     1,     2,
      33,    36,    37,    42,    49,    51,    52,    56,    61,    11,
      60,    73,    54,    83,    74,    31,    72,    32,    80,    62,
      47,    35
};

static const yytype_int8 yycheck[] =
{
       6,     7,    18,    19,    20,    21,    22,    53,     0,    15,
      16,    22,    53,    24,    25,    26,    75,    31,    77,    78,
      38,    36,    38,    38,    30,    57,    58,    57,    36,    38,
      52,    20,    20,    53,    27,    30,    35,    21,    54,    31,
      21,    35,    48,    23,    35,    24,    62,    25,    76,    55,
      40,    27
};
...
static const yytype_int8 yystos[] =
{
      ...
      67,    62,    64,    52,    93,    93,    20,    20,    68,    75,
      71,    66,    53,    79,    82,    86,    88,    79,    89,    27,
      76,    30,    35,    72,    68,    80,    21,    84,    87,    83,
      21,    66,    68,    77,    88,    88,    22,    24,    25,    26,
      90,    92,    66,    35,    35,    91,    81,    78,    85,    90,
      82,    90,    90,    23
};
...
static const yytype_int8 yyr1[] =
{
      ...
      79,    83,    82,    84,    85,    82,    86,    87,    86,    89,
      88,    90,    91,    90,    92,    92,    92,    93
};
...
#line 1737 "parser.tab.c"
  ...
  case 31: /* $@16: %empty  */
#line 123 "parser.y"
                      {if (need_tab) {tab=1; print_tabs(tab);} printf(" -> ");}
...
#line 1773 "parser.tab.c"
  ...
  case 43: /* Type: L_BRACKET_SQUARE $@21 Type R_BRACKET_SQUARE  */
#line 138 "parser.y"
                                                              {printf("]");}
#line 1779 "parser.tab.c"
    break;

  case 44: /* PrimitiveType: INT  */
#line 141 "parser.y"
            {printf("int");}
#line 1785 "parser.tab.c"
    break;

  case 45: /* PrimitiveType: CHAR  */
#line 141 "parser.y"
                                    {printf("char");}
#line 1791 "parser.tab.c"
    break;

  case 46: /* PrimitiveType: BOOL  */
#line 141 "parser.y"
                                                             {printf("bool");}
